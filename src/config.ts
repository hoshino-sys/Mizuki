...
export const siteConfig: SiteConfig = {
	title: "NightStar",
	subtitle: "Ciallo",
	siteURL: "https://nightstar.top", // 请替换为你的站点URL，以斜杠结尾
	...
	pageScaling: {
		...
		targetWidth: 1600, // 目标宽度，低于此宽度时开始缩放
	},
	...
	bilibili: {
		vmid: "1835212248", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/hoshino-sys",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1835212248",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/Nightshi",
					external: false,
					icon: "mdi:git",
				},
			],
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://twikoo-vercel-nu-ochre.vercel.app",
		lang: SITE_LANG,
	},
};
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		close: "QWQ 下次再见~", // 关闭提示
		link: "https://github.com/hoshino-sys", // 关于链接
	},
};
